...
public class GameOptionPanel extends JPanel {
	...
	private ImageIcon huaweisnakeIcon = new ImageIcon(GameOptionPanel.class
			.getResource("/huaweisnake.png"));
	...
	public GameOptionPanel() {
		...
		final JLabel label_logo = new JLabel(huaweisnakeIcon);
	...
	public ImageIcon getHuaweisnakeIcon() {
		return huaweisnakeIcon;
	}

	public void setHuaweisnakeIcon(ImageIcon huaweisnakeIcon) {
		this.huaweisnakeIcon = huaweisnakeIcon;
	}
